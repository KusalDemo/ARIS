"""
Serialize and parse protobuf messages to prove we did not break the contract.

CI also runs ``scripts/gen_proto.sh`` and fails if generated stubs drift; these tests catch
logic mistakes that still compile.
"""

from __future__ import annotations

from aris.policy.v1 import policy_pb2
