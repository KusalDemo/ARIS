...
from aris.policy.v1 import policy_pb2, policy_pb2_grpc
...
def grpc_stub():
    ...
    os.environ["ARIS_CONFIG"] = str(REPO_ROOT / "configs" / "aris.default.yaml")
    root = load_config(os.environ["ARIS_CONFIG"])
