...
The neural net always sees exactly 12 numbers in this order. If we change the order here
without updating configs/aris.default.yaml, training and the live policy service would disagree.
