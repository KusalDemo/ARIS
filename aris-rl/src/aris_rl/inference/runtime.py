...
Training uses either a flat DQN index or a PPO box; this file mirrors that for serving so the
live policy service picks the same knobs the agent learned in simulation.
"""
...
from aris_rl.envs.continuous_actions import decode_continuous_action
...
from aris_rl.envs.flat_actions import flat_to_multi, nvec_from_space
from aris_rl.observation.features import STATE_DIM
from aris_rl.safeguards import PolicyAction
...
class TorchInferenceRuntime:
    ...
    The YAML file decides whether to load this at all; skipped entirely when inference is off.
    """
