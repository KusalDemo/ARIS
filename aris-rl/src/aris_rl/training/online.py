...
Online training means the agent keeps playing the mock microservice and updates its weights
after each batch of experience. DQN uses a wrapper so the library sees one Discrete action
instead of MultiDiscrete.
"""
