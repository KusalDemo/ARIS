"""
PPO actions: a short Box vector (retry fraction, backoff, timeout in real units).

The policy network outputs continuous numbers; we clip them to YAML min/max before applying.
"""
