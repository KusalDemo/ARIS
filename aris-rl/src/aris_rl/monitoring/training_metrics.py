"""
Optional Prometheus numbers while you train (turn on in YAML under prometheus.enabled).

Think of this like a simple scoreboard: how much replay is on disk, how many learning steps
ran, and a smoothed reward line for Grafana — not the math the neural net uses internally.
"""
...
class TrainingMetricsExporter:
    ...
    def __init__(
        ...
        *,
        ...
        # One label only: dqn or ppo — keeps cardinality low (Prometheus stays fast on a laptop).
