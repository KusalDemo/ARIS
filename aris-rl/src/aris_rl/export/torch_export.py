...
TorchScript is a frozen copy of the neural net you can load in the policy service without
pulling in all of SB3. DQN exports the Q-network (one score per flat action). PPO exports
the actor mean vector. ONNX is optional so installs without extra packages stay small.
"""
...
def export_torchscript(
    ...
    *,
    ...
    if algo == "dqn":
        ...
        q_net = dqn.q_net
        q_net.eval()
        # trace = record one forward pass so TorchScript can replay it quickly at serving time.
